...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  useGSAP(() => {
    ...
    let targets: Element[];
    if (splitType === 'lines') targets = splitInstance.lines;
    else if (splitType === 'words') targets = splitInstance.words;
    else if (splitType === 'words, chars') targets = [...splitInstance.words, ...splitInstance.chars];
    else targets = splitInstance.chars;
  ...
  const style: React.CSSProperties = { textAlign, wordWrap: 'break-word', willChange: 'transform, opacity', visibility: 'hidden' };
